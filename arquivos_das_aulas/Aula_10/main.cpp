...
void initOpenGL()
{
    ...
    glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, 2 * sizeof(float)/*pode ser zero*/, 0);
    ...
    glVertexAttribPointer(1, 3, GL_UNSIGNED_BYTE, GL_TRUE, 3 * sizeof(GLubyte)/*pode ser zero*/, 0);
